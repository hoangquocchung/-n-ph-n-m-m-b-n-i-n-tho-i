...
namespace FormChinh.FORM
{
    public partial class frmNHANVIEN : Form
    {
        ...
        private void DataGridView_Click(object sender, EventArgs e)
        {
            ...
            txtGioitinh.Text = DataGridView.CurrentRow.Cells["Gioitinh"].Value.ToString();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblNhanvien(Manhanvien,Tennhanvien,Gioitinh, Diachi,Dienthoai, Ngaysinh) VALUES (N'" + txtManhanvien.Text.Trim() + "',N'" + txtTennhanvien.Text.Trim() + "',N'" + txtGioitinh.Text.Trim() + "',N'" + txtDiachi.Text.Trim() + "','" + mskDienthoai.Text + "','" + functions.ConvertDateTime(mskNgaysinh.Text) + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblNhanvien SET  Tennhanvien=N'" + txtTennhanvien.Text.Trim().ToString() +
                    ...
                    "',Dienthoai='" + mskDienthoai.Text.ToString() + "',Gioitinh=N'" + txtGioitinh.Text.Trim().ToString() +
